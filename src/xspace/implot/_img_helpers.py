...
def _img_to_base64(
        image, #: Union[str,str_,np.ndarray,PIL.Image],
    ...
    Parameters
    ----------
    image : str | numpy.str_ | numpy.ndarray | PIL.Image
        Input image can be either PIL.Image, numpy.ndarray | simply a string URL to local | external image file.
